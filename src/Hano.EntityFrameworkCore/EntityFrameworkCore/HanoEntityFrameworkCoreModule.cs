...
public class HanoEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<HanoDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also HanoMigrationsDbContextFactory for EF Core tooling. */
            options.UseNpgsql();
        });
