...
/// </summary>
public class UuidV7GuidGenerator : IGuidGenerator, ITransientDependency
{
    /// <summary>
    /// Gets the singleton <see cref="SequentialGuidGenerator"/> instance.
    /// </summary>
    //public static UuidV7GuidGenerator Instance { get; } = new UuidV7GuidGenerator();
    ...
    /// </summary>
    private UuidV7GuidGenerator(IOptions<AbpSequentialGuidGeneratorOptions> options)
    {
...
/*
    ...
    //context.Services.AddTransient<IGuidGenerator, UuidV7GuidGenerator>();
