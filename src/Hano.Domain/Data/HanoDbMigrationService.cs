...
public class HanoDbMigrationService : ITransientDependency
{
    public ILogger<HanoDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<IHanoDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;
    private readonly IConfiguration _configuration;
    public HanoDbMigrationService(
        IConfiguration configuration,
        IDataSeeder dataSeeder,
        IEnumerable<IHanoDbSchemaMigrator> dbSchemaMigrators,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<HanoDbMigrationService>.Instance;
    }
